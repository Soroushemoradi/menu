...
function App() {
  const hot = [
    { id: 'h1', title: 'سایفون', subtitle: 'دو کاپ، 20 الی 30 گرم پودر قهوه به روش نوین دم آوری', imageUrl: '/coffee1.jpg' },
    { id: 'h2', title: 'کاپوچینو', subtitle: 'خامه‌ای', imageUrl: '/Cappuccino.png' },
    { id: 'h3', title: 'لاته', subtitle: 'ترکیب هنر و قهوه، اسپرسو، فوم شیر، شیر بخار داده شده، خامه', imageUrl: '/Latte.jpg' },
    { id: 'h4', title: 'دمنوش', subtitle: 'گلاب، شربت زعفران، چهار گل، عرق کاسنی', imageUrl: '/damnosh.png' },
    { id: 'h5', title: 'موکا', subtitle: 'شکلاتی', imageUrl: '/Capture.PNG' },
    { id: 'h6', title: 'آمریکانو', subtitle: 'سبک و دلپذیر', imageUrl: '/coffee1.jpg' },
    { id: 'h7', title: 'هات چاکلت', subtitle: 'انبوهی از شکلات داغ، شیر، شکلات رنده شده، کاکائو، شکر، فوم شیر، بیسکویت، کپ', imageUrl: '/Cappuccino.png' },
    { id: 'h8', title: 'شوت اسپرسو', subtitle: 'اندازه کوچک', imageUrl: '/Capture.PNG' },
    { id: 'h9', title: 'شوت اسپرسو', subtitle: 'اندازه کوچک', imageUrl: '/damnosh.png' }
  ]
  ...
  const cold = [
    ...
    { id: 'c7', title: 'لیموناد قهوه', subtitle: 'ترش و جالب', imageUrl: '/Capture.PNG' },
    { id: 'c8', title: 'شیک وانیل', subtitle: 'نرم و خوشمزه', imageUrl: '/Capture.PNG' },
    { id: 'c9', title: 'شیک وانیل', subtitle: 'نرم و خوشمزه', imageUrl: '/Capture.PNG' }
  ]
  ...
  const cakes = [
    ...
    { id: 'k7', title: 'موس شکلات', subtitle: 'سبک و نرم', imageUrl: '/Capture.PNG' },
    { id: 'k8', title: 'تارت لیمو', subtitle: 'ترش و شیرین', imageUrl: '/Capture.PNG' },
    { id: 'k9', title: 'تارت لیمو', subtitle: 'ترش و شیرین', imageUrl: '/Capture.PNG' }
  ]
